...
from app.wiki.models import WikiBuildResult, WikiLintIssue, WikiPageContent, WikiPageSummary, WikiStatus
...
def rebuild() -> WikiBuildResult:
    result = WikiService(effective_config()).rebuild()
    if result.error:
